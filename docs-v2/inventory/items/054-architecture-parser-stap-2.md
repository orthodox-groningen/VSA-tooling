# Inventarisatie 054 — Parser stap 2

## Huidige locatie

`docs/architecture/parser-stap-2.md`
...
Deze stap introduceert: - regel/kolom-registratie. Fouten netjes kunnen rapporteren.
...
`docs-v2/history/parser/parser-stap-2.md`
