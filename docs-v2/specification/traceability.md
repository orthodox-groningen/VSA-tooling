...
| `validation.md` | `docs/spec/vsa-spec-v1.0.1.md`, `docs/user-guide-config-severity.md`                                                                                                                                                                                                  | Syntax- en semantische fouten plus severity-overrides   |
...
| `cli.md`        | `docs/cli-reference.md`                                                                                                                                                                                                                                               | CLI-interfacecontract                                   |

## Niet opgenomen als normatief onderdeel

| Bron                                  | Reden                                                                          |
| ------------------------------------- | ------------------------------------------------------------------------------ |
| `docs/spec/vsa-polyphony-proposal.md` | toekomstvoorstel; bewaren in architectuur/history, niet normatief in deze fase |
| `docs/spec/vsa-spec-v1.md`            | oudere versie; vervangen door `vsa-spec-v1.0.1.md` als actuele bron            |
| `docs/todo*.md`                       | open werk; hoort in proces/history, niet in normatieve specificatie            |
| `docs/architecture/parser-stap-*.md`  | implementatiegeschiedenis; hoort in history/architecture                       |
