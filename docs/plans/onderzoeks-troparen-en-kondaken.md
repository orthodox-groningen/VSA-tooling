...
Haast u ons te hulp te {-&/ko}{\men_} *
{/want} wij zijn {in_} ge{\vaar_} *
door het grote aantal onze over{tre_}{/din_}{\gen_}; *
{/laat} uw dienaren niet ledig van uw {heen_.}{\gaan_}, **
want gij zijt onze {e_}{\ni}ge {/hoop_}. [//:]
:::
...
::: vsa-notatie
T.4 [//:] Als de {Re_}gel {/des} ge{\loofs}
...
<!-- Bron: feesteigen\07-jul\07-17-grootmartelares-marina.md | type: chapter -->
...
ik sterf voor U om met U te {-&/le_&_}{\ven_}; *
{/aan}vaard mij als gift, want ik heb mijzelf uit liefde aan U ge{of_}{\ferd_}. **
...
[\\:] {-&/Ge}{/tooid} {\met} het {/sie}{/raad} der maag{/de}lijk{heid_} *
als met een onver{\welk_}{\ba}{\re} {\krans_}, *
en {/in} {/pur}per gekleed door het {-&\bloed} {/van} {/uw} {/mar}tel{dood_}, *
straalt gij heerlijk door wonderbare ge{/ne_.}zin{\gen_}, *
als het sieraad en de lof {\der} {/mar}{/te}{/&\la_&_}{\ren}, **
heilige martela{\res_} {\Ma_}{/&/&/&\&\&\&/ri-&-&-&-&-&-&_}{\na_}. [:]
:::

---

<!-- Bron: feesteigen\07-jul\07-20-profeet-elia.md | type: chapter -->
...
<!-- Bron: feesteigen\07-jul\07-22-maria-magdalena.md | type: chapter -->

### Tropaar

::: vsa-notatie
<!-- Tropaar Maria Magdalena, Toon 1 -->
...
<!-- Bron: samenstellingen\zondag-profeet-elias.md | type: chapter -->

### Tropaar van de Zondag (Toon 8)
...
::: vsa-notatie
<!-- Kondak Profeet Elia, Toon 2 -->
[/:] Profeet en {/Schouw_}er van Gods machti{/ge_} {/&\da_&_}{\den_}, *
vermaarde E{\li_}{\a_}, *
{/die} door uw {/woord_} de regenwolken {/ge}{/van_}{\gen_} {\hield_}, **
bid {\voor} {/ons} {/tot} de {\e}nig {/mens}{\lie_}{\ven_}{\de_} [:]
:::
...
<!-- Bron: weekdagen\dinsdag.md | type: chapter -->
...
<!-- Bron: weekdagen\donderdag.md | type: chapter -->
...
<!-- Bron: weekdagen\maandag.md | type: chapter -->
...
<!-- Bron: weekdagen\vrijdag-hemelum.md | type: chapter -->
...
<!-- Bron: weekdagen\zaterdag.md | type: chapter -->
