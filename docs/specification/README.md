...
wat de [VSA-notatie](@bron) en tooling moeten betekenen. Architectuurkeuzes,
...
| [Syntax](syntax.md)                 | [VSA-notatie](@bron)-syntax, [VSA-blokken](@), [modifiers](@), [pitch-markers](@) en EBNF.              |
| [Semantiek](semantics.md)           | Muzikale betekenis van [scopes](@), [modifiers](@), [muzikale posities](@) en [do-context](@).          |
...
| [Error-handling](error-handling.md) | Foutafhandeling en [diagnostics](@).                                                                    |
