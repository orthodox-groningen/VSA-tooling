...
glossaryText: "de kleinste muzikale eenheid binnen [VSA-notatie](@bron): één relatieve toonhoogtebeweging (één [EHM](@)), één duur (één [ELM](@)) en een koppeling aan één zangelement in een [VSA-scope](@)."
formPhrases:
  - muzikale positie
  - muzikale posities
glossaryNotes:
...
Goede/valide voorbeelden van Muzikale positie zijn:
- Eén [EHM](@) + één [ELM](@) + zangelement in een [scope](@)
- Elke `&`-gescheiden stap in een samengestelde [modifier](@)

Geen goede/niet valide voorbeelden van Muzikale positie zijn:
- Losse tekst buiten [scopes](@)
- Een hele melodie of [zangstuk](@bron) als één eenheid
...
- [modifier](@), [hoogte-modifier](@), [lengte-modifier](@), [vsa-scope](@), [EHM](@), [ELM](@)
