...
(zie ook [specificatie §4.1.2](../spec/vsa-spec-v1.0.1.md#412-yaml-frontmatter-in-vsa-bestanden)).
...
- **Meer detail?** Zie [specificatie §8.2](../spec/vsa-spec-v1.0.1.md#82-musicxml-export)
  en [§8.2.11 profielen](../spec/vsa-spec-v1.0.1.md#8211-musicxml-exportprofielen).
