...
Hier is een overzicht van de verschillende glyphs;
...
## Hoogtemarkers met halven omhoog

````markdown
::: vsa-notatie
[:] {+/op} {+\neer} {+-vlak} {+~niets} {#//dubbel} {♯\\\\\drie} [:]
:::
````
...
## Hoogtemarkers met halven omlaag
